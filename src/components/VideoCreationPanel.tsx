...
import { StartEndTab } from "./StartEndTab";
import { CharacterSyncTab } from "./CharacterSyncTab";
  ...
  return (
    <div className="flex h-full flex-col gap-4 px-4 pb-4 pt-2">
      <div className="flex-1 overflow-hidden rounded-lg border bg-white shadow-sm">
        {mode === 'text-to-video' && <TextToVideoTab />}
        ...
        {mode === 'start-end' && (
          <StartEndTab 
            ...
            setStartImages={setStartImages}
            endImages={endImages}
            setEndImages={setEndImages}
            handleSelectFiles={handleSelectFiles}
          />
        )}
